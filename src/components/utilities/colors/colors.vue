<template>
	<Pageheader heading="Colors" :maintitle='["Utilities", "Colors"]' />
	<!-- Start:: row-1 -->
	<div class="row">
		<div class="col-xl-12">
					...
					<div class="card custom-card">
						...
						<div class="card-body">
							<div class="row row-cols-12 d-flex align-items-center">
								...
								<div class="p-3 col">
									<div class="m-2 text-primary text-opacity-75 fw-semibold fs-14 text-center">Opacity-75
									</div>
									<p class="pb-0 mb-0 fw-semibold text-center"><code>.text-opacity-75</code></p>
								</div>
								<div class="p-3 col">
									<div class="m-2 text-primary text-opacity-50 fw-semibold fs-14 text-center">Opacity-50
									</div>
									<p class="pb-0 mb-0 fw-semibold text-center"><code>.text-opacity-50</code></p>
								</div>
								<div class="p-3 col">
									<div class="m-2 text-primary text-opacity-25 fw-semibold fs-14 text-center">Opacity-25
									</div>
			...
			<div class="card custom-card">
				...
				<div class="card-body">
					<div class="row row-cols-12 d-flex align-items-center">
						...
						<div class="p-3 col">
							<div class="m-2 bg-light-transparent mx-auto color-container border"></div>
					...
					<div class="row row-cols-12 d-flex align-items-center">
						<div class="p-3 col">
							<div class="m-2 bg-outline-primary mx-auto color-container"><i
									class="bi bi-emoji-smile fs-18"></i></div>
						...
						<div class="p-3 col">
							<div class="m-2 bg-outline-info mx-auto color-container"><i class="bi bi-emoji-smile fs-18"></i>
							</div>
						...
						<div class="p-3 col">
							<div class="m-2 bg-outline-dark mx-auto color-container"><i class="bi bi-emoji-smile fs-18"></i>
							</div>
