<template>
  <Pageheader heading="Columns " :maintitle='["Utilities", "Columns"]' />
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body bd-example-row">
              ...
              <p>You may also apply this break at specific breakpoints with our <span class="text-danger">responsive
                  display utilities.</span></p>
              <div class="container">
                <div class="row">
      ...
      <div class="card custom-card">
        <div class="card-body">
          <P>The classes can be used together with utilities to create responsive floated
            ...
            is shorter.</P>
          <div class="clearfix">
            <img src="/images/media/media-40.jpg"
              class="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="...">
            <p>
