<template>
  <Pageheader heading="Gutters " :maintitle='["Utilities", "Gutters"]' />
    ...
    <div class="col-xl-6">
      <div class="card custom-card">
        ...
        <div class="card-body">
          ...
          <p>An alternative solution is to add a wrapper around the <span class="text-danger">.row</span> with the <span
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <p>The gutters between columns in our predefined grid classes can be removed
            with
            <span class="text-danger">.g-0</span>. This removes the negative <span class="text-danger">margins</span> from
            <span class="text-danger">.row
            </span>and the horizontal <span class="text-danger">padding</span>
            from all immediate children columns.
          </p>
          <p>Need an edge-to-edge design? Drop the parent <span class="text-danger">.container</span> or <span
