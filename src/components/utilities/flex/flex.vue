<template>
  <Pageheader heading="Flex " :maintitle='["Utilities", "Flex"]' />
  <!-- Start:: row-1 -->
        ...
        <div class="card-body">
          <div class="d-flex mb-3">
            <div class="flex-shrink-0">
              <img class="bd-placeholder-img card-img w-10 h-10" src="/images/faces/6.jpg" alt="img">
            </div>
            <div class="flex-grow-1 ms-3">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus recusandae blanditiis voluptas nobis
              consectetur. Voluptate pariatur, odit repudiandae sint, libero laborum aut vel, ut enim laboriosam explicabo
              dolor corporis hic.
            </div>
          </div>
          ...
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <img class="bd-placeholder-img card-img avatar-xl" src="/images/faces/15.jpg" alt="img">
            </div>
            <div class="flex-grow-1 ms-3">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus, accusamus fuga quis deserunt provident
              rem illum exercitationem laborum pariatur modi blanditiis a dolor excepturi qui, aut laudantium harum in
              id..
            </div>
          </div>
        </div>
