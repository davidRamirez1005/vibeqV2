<template>
  <Pageheader heading="More " :maintitle='["Utilities", "More"]' />
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body">
              <p><a href="javascript:void(0);" class="pe-none" tabindex="-1"><code
                    class="text-primary fw-semibold">This link</code></a>
                can
                not be clicked.
              </p>
              <p><a href="javascript:void(0);" class="pe-auto"><code class="text-primary fw-semibold">This link</code></a>
                can be clicked (this is default
                behavior).
              </p>
              <p class="pe-none mb-0"><a href="javascript:void(0);" tabindex="-1"><code>This link</code></a>
                can
                not be clicked because the <code class="text-primary fw-semibold">pointer-events</code> property is
                inherited
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body d-md-flex">
              ...
              <div class="overflow-visible p-3 mb-3 mb-md-0 me-md-3 bg-light fs-12"
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body">
              <span class="me-1 align-baseline">baseline</span>
              <span class="me-1 align-top">top</span>
              <span class="me-1 align-middle">middle</span>
              <span class="me-1 align-bottom">bottom</span>
              <span class="me-1 align-text-top">text-top</span>
              <span class="me-1 align-text-bottom"> text-bottom</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card custom-card">
            ...
            <div class="card-body">
              <div class="mx-auto"
                style="width: 200px; padding: 10px; border-radius: 4px; background-color: rgba(86,61,124,.15);">
                Centered element
              </div>
            </div>
          </div>
  ...
  <div class="row row-sm">
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          ...
          <div style="height: 100px; background-color: rgba(255,0,0,0.1);" class="d-flex">
            <div class="h-25 d-inline-block p-1" style="width: 120px; background-color: rgba(0,0,255,.1)">Height 25%
            </div>
            <div class="h-50 d-inline-block p-1" style="width: 120px; background-color: rgba(0,0,255,.1)">Height 50%
            </div>
            <div class="h-75 d-inline-block p-1" style="width: 120px; background-color: rgba(0,0,255,.1)">Height 75%
            </div>
            <div class="h-100 d-inline-block p-1" style="width: 120px; background-color: rgba(0,0,255,.1)">Height 100%
            </div>
            <div class="h-auto d-inline-block p-1" style="width: 120px; background-color: rgba(0,0,255,.1)">Height auto
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-6">
      <div class="card custom-card">
        <div class="card-header">
          <div class="card-title">
            You can also use <span class="text-danger"> max-width: 100%;</span> and <Span class="text-danger">max-height:
              100%;</Span> utilities as needed.
          </div>
        </div>
        <div class="card-body">
          <img class="bd-placeholder-img mw-100 card-img" src="/images/media/media-7.jpg" alt="...">
          <div style="height: 100px; background-color: rgba(255,0,0,.1);" class="mt-3">
            <div class="mh-100 p-2" style="width: 100px; height: 200px; background-color: rgba(0,0,255,.1);">
              Max-height 100%</div>
          </div>
        </div>
      </div>
