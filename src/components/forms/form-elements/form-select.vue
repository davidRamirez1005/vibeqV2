...
<template>
    <Pageheader heading="Form Select" :maintitle='["Forms", "Form Elements", "Form Select"]' />
            ...
            <div class="row">
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <multiselect1 :show-labels="false" v-model="multigroupvalue" :options="groupOptions"
                                ...
                                placeholder="Type to search" track-by="name" label="name"><span slot="noResult">Oops! No
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body tags-multiselect">
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <multiselect1 :show-labels="false" v-model="singleSelecteValue"
                                :options="singleSelecteOptions"></multiselect1>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <multiselect1 :show-labels="false" v-model="edvalue" :options="singleSelecteOptions"
                                ...
                                placeholder="Pick a value"></multiselect1>
