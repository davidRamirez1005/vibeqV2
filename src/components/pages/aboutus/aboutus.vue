<template>
  <Pageheader heading="About Us" :maintitle='["Pages", "About Us"]' />
  <!-- Start::row-1 -->
  <div class="container">
    <!-- Row-->
    <div class="row row-sm">
      <div class="col-xl-12">
        <div class="text-center p-4">
          ...
          <p class="px-0 px-md-5">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
    ...
    <div class="row row-sm">
      <div class="col-xl-12">
        <div class="card custom-card">
          <img src="/images/media/jobs-landing/blog/16.jpg" alt="img" class="rounded-2">
        </div>
      </div>
    </div>
    <!-- End Row -->
        ...
        <div class="row row-sm">
          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="mt-5">
              ...
              <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered by
                injected humour, or randomised words which don't look even slightly believable.</p>
              <p>All the Lorem Ipsum generators on the Internet tend to repeat Various versions have evolved over the
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="text-xl-end text-center">
              <img src="/images/pngs/30.png" alt="img" class="rounded-6">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row row-sm">
      <div class="col-xl-12">
        <div class="pt-5 pb-4">
          ...
          <p class="fs-14 mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam similique provident
            Lorem ipsum dolor sit amet consectetur !</p>
          <div>
            <div class="d-flex mb-4">
              <div>
                <svg class="moto-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                  viewBox="0 0 24 24">
                  <path fill="#b2b1ff"
              ...
              <div class="ms-4">
                <h5 class="fs-medium">Hardworking !</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quos sint, officia vel ab
                  perferendis, dolores placeat dolor aliquam debitis eius, illum ullam ratione blanditiis fugiat omnis
                  beatae odio vitae!</p>
              </div>
            </div>
            <div class="d-flex mb-4">
              <div>
                <svg class="moto-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                  viewBox="0 0 24 24">
                  <path fill="#6d7ee5" d="M18.30652,12.22144C17.42371,13.00647,16.27399,13.49854,15,13.5c-0.27161,0-0.53668-0.02515-0.79553-0.06805
              ...
              <div class="ms-4">
                <h5 class="fs-medium">Team Work for Better Results !</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quos sint, officia vel ab perferendis
                  illum ullam ratione blanditiis fugiat omnis beatae odio vitae!</p>
              </div>
            </div>
            <div class="d-flex">
              <div>
              ...
              <div class="ms-4">
                <h5 class="fs-medium">Best Quality !</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quos sint, officia vel ab
                  perferendis, dolores placeat dolor aliquam debitis eius, illum ullam ratione blanditiis fugiat omnis
                  beatae odio vitae!</p>
              </div>
          ...
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg class="statistics-icon bg-secondary-transparent" xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="text-center mb-1">
                <h2 class="counter mb-2 fs-normal">5,432</h2>
                <h6 class="mb-0 text-muted fs-normal">Total Customers</h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card custom-card bg-primary-transparent">
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg class="statistics-icon bg-warning-transparent" xmlns="http://www.w3.org/2000/svg"
                  enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                  <path fill="#ffc37a"
              ...
              <div class="text-center mb-1">
                <h2 class="counter mb-2 fs-normal">500</h2>
                <h6 class="mb-0 text-muted fs-normal">Employees</h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card custom-card bg-primary-transparent">
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg class="statistics-icon bg-danger-transparent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path fill="#fd6074"
              ...
              <div class="text-center mb-1">
                <h2 class="counter mb-2 fs-normal">298</h2>
                <h6 class="mb-0 text-muted fs-normal">Completed Projects</h6>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card custom-card bg-primary-transparent">
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg class="statistics-icon bg-info-transparent" xmlns="http://www.w3.org/2000/svg"
                  enable-background="new 0 0 24 24" viewBox="0 0 24 24">
              ...
              <div class="text-center mb-1">
                <h2 class="counter mb-2 fs-normal">180</h2>
                <h6 class="mb-0 text-muted fs-normal">Awards won</h6>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row row-sm">
        ...
        <div class="card custom-card our-team">
          <div class="card-body">
            <div class="picture avatar-lg online text-center">
              <img alt="avatar" class="rounded-circle" src="/images/faces/5.jpg">
            </div>
            <div class="text-center mt-3">
              <router-link :to="`${url}pages/profile`">
                <h5 class="pro-user-username text-dark mt-2 mb-0">Dennis Trexy</h5>
              </router-link>
              <p class="pro-user-desc text-muted mb-1">Web Developer</p>
              <div class="text-center fs-14 mb-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam !
              </div>
            </div>
            <div class="text-center mt-3">
              <a href="https://www.facebook.com/" target="_blank"
                class="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1"><i
                  class="mdi mdi-facebook"></i></a>
              <a href="https://myaccount.google.com/" target="_blank"
                class="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1"><i
                  class="mdi mdi-google"></i></a>
              <a href="https://twitter.com/" target="_blank"
                class="btn btn-sm ripple bg-info-transparent text-info rounded-circle"><i class="mdi mdi-twitter"></i></a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card custom-card our-team">
          <div class="card-body">
            <div class="picture avatar-lg online text-center">
              <img alt="avatar" class="rounded-circle" src="/images/faces/1.jpg">
            </div>
            <div class="text-center mt-3">
              <router-link :to="`${url}pages/profile`">
                <h5 class="pro-user-username text-dark mt-2 mb-0">Benedict Vallone</h5>
              </router-link>
      ...
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card custom-card our-team">
          <div class="card-body">
            <div class="picture avatar-lg online text-center">
              <img alt="avatar" class="rounded-circle" src="/images/faces/7.jpg">
            </div>
            <div class="text-center mt-3">
              <router-link :to="`${url}pages/profile`">
                <h5 class="pro-user-username text-dark mt-2 mb-0">Robbie Ruder</h5>
              </router-link>
              <p class="pro-user-desc text-muted mb-1">Web Developer</p>
              <div class="text-center fs-14 mb-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam !
              </div>
      ...
      <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        <div class="card custom-card our-team">
          <div class="card-body">
            <div class="picture avatar-lg online text-center">
              <img alt="avatar" class="rounded-circle" src="/images/faces/8.jpg">
            </div>
            <div class="text-center mt-3">
              <router-link :to="`${url}pages/profile`">
