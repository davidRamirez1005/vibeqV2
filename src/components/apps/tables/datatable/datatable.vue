<template>
  <!-- Row -->
  <Pageheader heading="DataTable " :maintitle='["Apps", "Tables", "Data Table"]' />
  ...
  <div class="row">
    <div class="col-xl-12">
      <div class="card custom-card">
        <div class="card-header">
          <div class="card-title">Expandable row</div>
        </div>
        <div class="card-body">

          <EasyDataTable class="table text-nowrap" :headers="headers" :items="items" :rowsPerPage="5"
            :rowsItems="[5, 10, 25, 50, 100]">
  ...
  <div class="row row-sm">
    <div class="col-lg-12">
      <div class="card custom-card">
        <div class="card-body">
          <div>
            <h6 class="main-content-label mb-1">Sorting, Pagination Table</h6>
            <p class="text-muted card-sub-title">
              DataTable using vue-good-table-next
            </p>
          </div>
          <Sample3datatable></Sample3datatable>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row row-sm">
    <div class="col-lg-12">
      <div class="card custom-card">
        <div class="card-body">
          <div>
            <h6 class="main-content-label mb-1">Sample max-height DataTable</h6>
            <p class="text-muted card-sub-title">
              DataTable using vue-good-table-next
            </p>
          </div>
          <Sample4datable></Sample4datable>
        </div>
      </div>
    </div>
  </div>
...
import Sample3datatable from "./Sample3datatable.vue";
import Sample4datable from "./Sample4datable.vue";
