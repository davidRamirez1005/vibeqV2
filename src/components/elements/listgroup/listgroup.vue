<template>
  <!-- Row -->
  <Pageheader heading="Listgroup" :maintitle='["Elements", "Listgroup"]' />
  ...
  <div class="row">
    ...
    <div class="col-xl-4">
      <showcodeCard title="Disabled items" :code="prism.DisabledItems">
        <ul class="list-group">
    ...
    <div class="col-xl-4">
      <showcodeCard title="Flush" :code="prism.flush">
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item fw-semibold"><i class="bi bi-tiktok align-middle me-2 text-muted"></i>Alezander
            Russo<span class="ms-1 text-muted fw-normal d-inline-block">(+7546-12342)</span></li>
          ...
          <li class="list-group-item fw-semibold"><i class="bi bi-facebook align-middle me-2 text-muted"></i>Melissa
            Brien<span class="ms-1 text-muted fw-normal d-inline-block">(+1023-34323)</span></li>
          <li class="list-group-item fw-semibold"><i class="bi bi-instagram align-middle me-2 text-muted"></i>Kamala
            Harris<span class="ms-1 text-muted fw-normal d-inline-block">(+91-63421)</span></li>
        </ul>
      </showcodeCard>
    </div>
    <div class="col-xl-4">
  ...
  <div class="row">
    ...
    <div class="col-xl-6">
      ...
      <showcodeCard title="Contextual classes with hover styles" :code="prism.ContextualClassesWithHoverStyles">
        <div class="list-group">
  ...
  <div class="row">
    ...
    <div class="col-xl-4">
      <showcodeCard title="List With Checkboxes" :code="prism.ListWithCheckboxes">
        <ul class="list-group">
          <li class="list-group-item">
...
import * as prism from '@/data/prismCode/ui-elements/listgroup.js';
