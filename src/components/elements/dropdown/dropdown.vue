<template>
  <Pageheader heading="DropDown" :maintitle='["Elements", "Dropdown"]' />
  <!--Start:: row-1-->
  <div class="row">
    <div class="col-xl-12">
  ...
  <div class="row">
    ...
    <div class="col-xl-6">
      ...
      <showcodeCard title="Rounded Outline Dropdowns" :code="prism.roundedOutlineDropdowns">
        <div class="btn-list">
          <div class="btn-group">
            <button type="button" class="btn btn-outline-primary dropdown-toggle rounded-pill" data-bs-toggle="dropdown"
              aria-expanded="false">
              Action
            </button>
            <ul class="dropdown-menu">
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-outline-secondary dropdown-toggle rounded-pill" data-bs-toggle="dropdown"
              aria-expanded="false">
              Action
            </button>
            <ul class="dropdown-menu">
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-outline-success dropdown-toggle rounded-pill" data-bs-toggle="dropdown"
              aria-expanded="false">
              Action
            </button>
            <ul class="dropdown-menu">
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-outline-warning dropdown-toggle rounded-pill" data-bs-toggle="dropdown"
              aria-expanded="false">
              Action
            </button>
            <ul class="dropdown-menu">
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-outline-danger dropdown-toggle rounded-pill" data-bs-toggle="dropdown"
              aria-expanded="false">
              Action
            </button>
            <ul class="dropdown-menu">
  ...
  <div class="row">
    <div class="col-xl-6">
      ...
      <showcodeCard title="Split buttons" :code="prism.splitButtons">
        ...
        <div class="btn-group my-1">
          ...
          <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle-split me-2" data-bs-toggle="dropdown"
            aria-expanded="false">
            <span class="visually-hidden">Toggle Dropdown</span>
          </button>
          <ul class="dropdown-menu">
    ...
    <div class="col-xl-6">
      ...
      <showcodeCard title="Dropdown Sizing" :code="prism.dropdownSizing">
  ...
  <div class="row">
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropup" :code="prism.dropup">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropup right" :code="prism.dropupRight">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropup left" :code="prism.dropupLeft">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Active" :code="prism.active">
        <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          Dropstart
        </button>
        <ul class="dropdown-menu">
  ...
  <div class="row">
    <div class="col-xl-3">
      <showcodeCard title="Disabled" :code="prism.disabled">
        <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          Dropstart
        </button>
        <ul class="dropdown-menu">
    ...
    <div class="col-xl-6">
      ...
      <showcodeCard title="Auto close behavior" :code="prism.autoCloseBehavior">
        <div class="btn-list">
          <div class="btn-group">
            <button class="btn btn-primary dropdown-toggle" type="button" id="defaultDropdown" data-bs-toggle="dropdown"
  ...
  <div class="row">
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropdown menu centered" :code="prism.dropdownMenuCentered">
        ...
        <div class="dropdown-center">
          <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownCenterBtn" data-bs-toggle="dropdown"
            aria-expanded="false">
            Centered dropdown
          </button>
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropup centered" :code="prism.dropupCentered">
        <p class="card-title mb-3">Use <code>.dropup-center</code>
          on the parent element.
        </p>
        <div class="dropup-center dropup">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="dropupCenterBtn" data-bs-toggle="dropdown"
            aria-expanded="false">
            Centered dropup
          </button>
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Menu items" :code="prism.menuItems">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropdowns options" :code="prism.dropdownsOptions">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="btn-group">
            ...
            <button type="button" class="btn btn-info dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference"
  ...
  <div class="row">
    <div class="col-xl-4">
      ...
      <showcodeCard title="Menu alignment" :code="prism.menuAlignment">
        <div class="btn-group">
          <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="col-xl-4">
      ...
      <showcodeCard title="Responsive alignment end" :code="prism.responsiveAlignmentEnd">
        <div class="btn-group">
    ...
    <div class="col-xl-4">
      ...
      <showcodeCard title="Responsive alignment left" :code="prism.responsiveAlignmentLeft">
        <div class="btn-group">
  ...
  <div class="row">
    <div class="col-xl-3">
      ...
      <showcodeCard title="non-interactive dropdown items" :code="prism.nonInteractiveDropdownItems">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropdown Headers" :code="prism.dropdownHeaders">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropdown Dividers" :code="prism.dropdownDividers">
        <div class="bd-example">
          <ul class="dropdown-menu">
    ...
    <div class="col-xl-3">
      ...
      <showcodeCard title="Dropdown Menu Text" :code="prism.dropdownMenuText">
        <div class="bd-example">
...
import * as prism from '@/data/prismCode/ui-elements/dropdown.js';
export default {
  components: { Pageheader, showcodeCard }, data() {
    return { prism }
  }
};
</script>
