...
import { menuData } from '@/data/landingmenuData.js';
import { Swiper, SwiperSlide } from "swiper/vue";
import "swiper/swiper-bundle.css";
import { Navigation, Pagination, Keyboard, Autoplay, FreeMode } from 'swiper/modules';
export default {
  components: {
    landingpagemenu,
    Swiper,
...
<template>
  ...
  <div class="landing-page-wrapper">
    ...
    <header class="app-header">
      ...
      <div class="main-header-container container-fluid">
        ...
        <div class="header-content-left">
          ...
          <div class="header-element">
            <div class="horizontal-logo">
              <router-link :to="`${url}dashboard`" class="header-logo">
                ...
                <!-- <img src="/images/brand-logos/toggle-white.png" alt="logo" class="toggle-logo"> -->
          ...
          <div class="header-element">
            <!-- Start::header-link -->
            <a @click="ToggleMenu" href="javascript:void(0);" class="sidemenu-toggle header-link"
        ...
        <div class="header-content-right">
          ...
          <div class="header-element align-items-center">
            ...
            <div class="btn-list d-lg-none d-block">
              <router-link :to="`${url}custompages/signup`" class="btn btn-primary-light">
                New User
              </router-link>
              <router-link :to="`${url}custompages/signin`" class="btn btn-primary-light">
                Login
              </router-link>
            </div>
            <div class="header-element"><!-- Start::header-link|switcher-icon --><a href="javascript:void(0);"
                class="header-link switcher-icon" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas"><i
                  class="fe fe-settings header-link-icon"></i></a><!-- End::header-link|switcher-icon --></div>
          </div>
          <!-- End::header-element -->
      ...
      <div class="container p-0">
        ...
        <div class="main-sidebar">
          ...
          <nav class="main-menu-container nav nav-pills sub-open">
            ...
            <landingpagemenu :menuData="menuData"></landingpagemenu>
            <div class="d-lg-flex d-none align-items-center">
              <div class="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                <router-link :to="`${url}custompages/signup`" class="btn btn-wave btn-secondary">
                  New User
                </router-link>
                <router-link :to="`${url}custompages/signin`" class="btn btn-wave btn-info">
                  Login
                </router-link>
              </div>
              <div class="header-element ps-2"><!-- Start::header-link|switcher-icon --><a href="javascript:void(0);"
                  class="header-link switcher-icon" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas"><i
                    class="fe fe-settings header-link-icon"></i></a><!-- End::header-link|switcher-icon --></div>
            </div>
          </nav>
    ...
    <div class="main-content landing-main">
      ...
      <!-- Start:: Section-1 -->
      <div class="landing-banner landing-top-header" id="home">
        <section class="section demo-screen-headline main-demo-1">
          <div class="container main-banner-container">
            <div class="row">
              <div class="col-xl-6 col-lg-6 animation-zidex position-relative">
                <h4 class="fw-medium mt-7">Manage Your Business</h4>
                <p class="text-start fw-bold">We Help to Build Your Dream Project with Spruha !</p>
                <h6 class="pb-3">
                ...
                <div class="btn-list">
                  <a href="https://themeforest.net/item/spruha-vue-admin-template/42292919" target="_blank"
                    class="btn btn-sm btn-w-sm mb-3 me-2 btn-light"><i class="fe fe-play me-2"></i> Get Started
                  </a>
                  <a href="https://themeforest.net/user/spruko/portfolio"
                    class="btn btn-sm btn-w-sm btn-outline-light mb-3 me-2 text-fixed-white" target="_blank"><i
                      class="fe fe-eye me-2"></i>Discover More
                  </a>
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 my-auto">
                <img src="/landing/images/4.png" alt="">
              </div>
            </div>
          </div>
        </section>
      ...
      <!-- Start:: Section-2 -->
      <section class="section hor-content main_features" id="features">
        <div class="container">
          <div class="row">
            <h4 class="text-center fw-medium landing-card-header">Features</h4>
            <span class="landing-title"></span>
            <h2 class="fw-medium text-center">Spruha Main Features</h2>
            <p class="text-default mb-5 text-center">The Spruha vue admin template comes with
              ready-to-use features that are completely easy-to-use for any user, even for
              a beginner.</p>
            <div class="row mt-7">
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-1 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-package text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-2 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-code text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-3 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-layers text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-4 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-book-open text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-5 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-file text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-6 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-aperture text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-7 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-box text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="card features border text-center main-features main-features-8 wow fadeInUp reveal revealleft"
                  data-wow-delay="0.1s">
                  <div class="card-body">
                    <div class="counter-body-2">
                      <div class="bg-img mb-2 text-left hexagon-wrapper">
                        <div class="counter-icon hexagon">
                          <i class="fe fe-file-text text-fixed-white"></i>
                        </div>
                      </div>
                    </div>
                    <div class="text-left counter-body">
                                  ...
                                  <div class="card reveal">
                                    <div class="bg-transparent">
                                      <div class="counter-status">
                                        ...
                                        <div class="test-body text-center text-fixed-white">
                                          <h1 class="fw-semibold mb-0"><span class="count">130</span>+</h1>
                                  ...
                                  <div class="card reveal">
                                    <div class="bg-transparent">
                                      <div class="counter-status">
                                        ...
                                        <div class="test-body text-center text-fixed-white">
                                          <h1 class="fw-semibold mb-0"><span class="count">20</span>+</h1>
                                          <div class="counter-text">
                                            <h5 class="fw-normal mb-0">
                                              Plugins</h5>
                                          </div>
                                  ...
                                  <div class="card reveal">
                                    <div class="bg-transparent">
                                      <div class="counter-status">
                                        ...
                                        <div class="test-body text-center text-fixed-white">
                                          <h1 class="fw-semibold mb-0"><span class="count">10</span>+</h1>
                                          <div class="counter-text">
                                            <h5 class="fw-normal mb-0">
                                              Form Elements</h5>
                                          </div>
                                  ...
                                  <div class="card reveal">
                                    <div class="bg-transparent">
                                      <div class="counter-status">
                                        ...
                                        <div class="test-body text-center text-fixed-white">
                                          <h1 class="fw-semibold mb-0"><span class="count">15</span>+</h1>
                                          <div class="counter-text">
                                            <h5 class="fw-normal mb-0">
                                              Widgets</h5>
                                          </div>
      ...
      <!-- Start:: Section-3 -->
      <section class="section bg-landing working-section" id="about">
        <div class="container">
          <div class="row">
            <h4 class="text-center fw-medium landing-card-header">Our Mission</h4>
            <span class="landing-title"></span>
            <div class="text-center">
              <h2 class="text-center fw-medium">Our mission is to make work meaningful.
              </h2>
            </div>
            <div class="reveal">
                    ...
                    <div class="working-svg-container svg-container-1">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 700">
                        <g data-name="Web Design and Development">
                          ...
                          <ellipse cx="519.505" cy="604.567" fill="#f2f2f2" rx="273.55" ry="10.277" />
                          <path fill="#7cb3e2"
                          ...
                          <rect width="131.404" height="35.287" x="453.803" y="544.617" fill="#b5b5b5" />
                          <path fill="#e2e0e1"
                          ...
                          <circle cx="519.505" cy="510.551" r="10.509" fill="#f2f2f2" />
                          <rect width="284.437" height="119.889" x="494.852" y="160.041" fill="#f2f2f2" />
                          <rect width="199.868" height="10.486" x="515.722" y="176.711" fill="#6fcece" />
                          <rect width="147.067" height="6.941" x="515.722" y="197.03" fill="#cccacb" />
                          <rect width="70.814" height="7.475" x="515.722" y="232.804" fill="#cccacb" />
                          <rect width="70.814" height="7.475" x="689.19" y="232.804" fill="#cccacb" />
                          <rect width="40.071" height="7.475" x="515.722" y="250.562" fill="#cccacb" />
                          <rect width="70.814" height="7.475" x="602.456" y="232.804" fill="#cccacb" />
                          <rect width="40.071" height="7.475" x="602.456" y="250.562" fill="#cccacb" />
                          <rect width="70.814" height="7.475" x="309.877" y="421.881" fill="#cccacb" />
                          <rect width="40.071" height="7.475" x="309.877" y="439.639" fill="#cccacb" />
                          <rect width="70.814" height="7.475" x="445.929" y="421.881" fill="#cccacb" />
                          <rect width="40.071" height="7.475" x="445.929" y="439.639" fill="#cccacb" />
                          <rect width="70.814" height="7.475" x="581.981" y="421.881" fill="#cccacb" />
                          <rect width="40.071" height="7.475" x="581.981" y="439.639" fill="#cccacb" />
                          <rect width="40.071" height="7.475" x="689.19" y="250.562" fill="#cccacb" />
                          <path
                          ...
                          <rect width="98.346" height="16.29" x="147.46" y="236.238" fill="#a5c9eb" />
                          <rect width="98.346" height="16.291" x="147.46" y="268.517" fill="#a5c9eb" />
                          <path fill="#ff8e00"
                            d="M226.98142,308.08173H208.404a5.77025,5.77025,0,0,0,0,11.5405h18.5774a5.77025,5.77025,0,0,0,0-11.5405Z" />
                          <rect width="290.928" height="40.941" x="283.17" y="134.83" fill="#a5c9eb" />
                          <rect width="153.228" height="71.328" x="314.224" y="217.75" style="mix-blend-mode:multiply"
                            fill="#e2e0e1" />
                          <rect width="153.228" height="71.328" x="311.458" y="214.87" fill="#6fcece" />
                          <rect width="49.898" height="9.852" x="385.148" y="234.369" fill="#0e9b9b" />
                          <rect width="71.55" height="7.014" x="385.148" y="250.296" fill="#0e9b9b" />
                          <rect width="71.55" height="7.014" x="385.148" y="261.634" fill="#0e9b9b" />
                          <rect width="59.53" height="7.014" x="385.148" y="272.971" fill="#0e9b9b" />
                          <polygon fill="#f2f2f2"
                          ...
                          <rect width="45.058" height="5.688" x="483.112" y="196.01" fill="#5a48b4" />
                          <rect width="68.164" height="3.478" x="499.333" y="208.42" fill="#fc0" />
                          <rect width="39.409" height="3.478" x="522.189" y="216.508" fill="#7463cd" />
                          <rect width="19.667" height="3.478" x="499.333" y="216.508" fill="#b29bee" />
                          <rect width="11.287" height="3.478" x="547.09" y="224.596" fill="#7463cd" />
                          <rect width="19.756" height="3.478" x="524.774" y="224.596" fill="#c1b3f4" />
                          <rect width="22.452" height="3.478" x="499.333" y="224.596" fill="#7463cd" />
                          <rect width="42.022" height="3.478" x="499.333" y="232.684" fill="#b29bee" />
                          <rect width="12.233" height="3.477" x="499.333" y="240.772" fill="#7463cd" />
                          <rect width="22.807" height="3.478" x="544.691" y="232.684" fill="#7463cd" />
                          <rect width="11.157" height="3.477" x="540.377" y="240.772" fill="#b29bee" />
                          <rect width="22.807" height="3.477" x="515.362" y="240.772" fill="#7463cd" />
                          <rect width="45.058" height="5.688" x="483.112" y="252.543" fill="#5a48b4" />
                          <rect width="68.164" height="3.478" x="499.333" y="264.952" fill="#fc0" />
                          <rect width="39.409" height="3.478" x="522.189" y="273.04" fill="#7463cd" />
                          <rect width="19.667" height="3.478" x="499.333" y="273.04" fill="#b29bee" />
                          <rect width="11.287" height="3.478" x="547.09" y="281.128" fill="#7463cd" />
                          <rect width="19.756" height="3.478" x="524.774" y="281.128" fill="#c1b3f4" />
                          <rect width="22.452" height="3.478" x="499.333" y="281.128" fill="#7463cd" />
                          <rect width="42.022" height="3.477" x="499.333" y="289.216" fill="#b29bee" />
                          <rect width="12.233" height="3.478" x="499.333" y="297.304" fill="#7463cd" />
                          <rect width="22.807" height="3.477" x="544.691" y="289.216" fill="#7463cd" />
                          <rect width="11.157" height="3.478" x="540.377" y="297.304" fill="#b29bee" />
                          <rect width="22.807" height="3.478" x="515.362" y="297.304" fill="#7463cd" />
                          <rect width="45.058" height="5.688" x="483.112" y="309.075" fill="#5a48b4" />
                          <rect width="68.164" height="3.478" x="499.333" y="321.485" fill="#fc0" />
                          <rect width="39.409" height="3.478" x="522.189" y="329.573" fill="#7463cd" />
                          <rect width="19.667" height="3.478" x="499.333" y="329.573" fill="#b29bee" />
                          <rect width="11.287" height="3.478" x="547.09" y="337.661" fill="#7463cd" />
                          <rect width="19.756" height="3.478" x="524.774" y="337.661" fill="#c1b3f4" />
                          <rect width="22.452" height="3.478" x="499.333" y="337.661" fill="#7463cd" />
                          <rect width="42.022" height="3.477" x="499.333" y="345.749" fill="#b29bee" />
                          <rect width="12.233" height="3.478" x="499.333" y="353.837" fill="#7463cd" />
                          <rect width="22.807" height="3.477" x="544.691" y="345.749" fill="#7463cd" />
                          <rect width="11.157" height="3.478" x="540.377" y="353.837" fill="#b29bee" />
                          <rect width="22.807" height="3.478" x="515.362" y="353.837" fill="#7463cd" />
                          <rect width="44.074" height="44.074" x="259.547" y="403.04" fill="#7cb3e2" rx="4.821" />
                          <rect width="44.074" height="44.074" x="395.337" y="403.04" fill="#7cb3e2" rx="4.821" />
                          <rect width="44.074" height="44.074" x="531.126" y="403.04" fill="#7cb3e2" rx="4.821" />
                          <ellipse cx="137.702" cy="611.964" fill="#f2f2f2" rx="44.517" ry="7.541" />
                          <path fill="#397c77"
                          ...
                          <rect width="153.228" height="71.328" x="285.936" y="188.299" style="mix-blend-mode:multiply"
                            fill="#8d7de0" opacity=".5" />
                          <rect width="153.228" height="71.328" x="283.17" y="185.419" fill="#8d7de0" />
                          <rect width="49.898" height="9.852" x="354.99" y="204.918" fill="#5a48b4" />
                          <rect width="71.55" height="7.014" x="354.99" y="220.845" fill="#7463cd" />
                          <rect width="71.55" height="7.014" x="354.99" y="232.182" fill="#7463cd" />
                          <rect width="59.53" height="7.014" x="354.99" y="243.52" fill="#7463cd" />
                          <polygon fill="#f2f2f2"
                          ...
                          <circle cx="293.424" cy="286.029" r="2.681" fill="#31c9ce" />
                          <circle cx="302.667" cy="286.029" r="2.681" fill="#fc0" />
                          <circle cx="311.911" cy="286.029" r="2.681" fill="#e74445" />
                          <rect width="79.494" height="68.032" x="290.743" y="295.078" fill="#f9b40f" rx="4.437" />
                          <path fill="#fff"
                ...
                <div class="row align-items-center justify-content-center">
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 myorder-1">
                    <div class="working-svg-container svg-container-2">
                      <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0" y="0" enable-background="new 0 0 300 300"
    ...
    c0.0995483,0.132843,0.1769714,0.2875366,0.2211761,0.4645081l5.6177063,20.5797119L237.9437103,183.34729z" />
                              <ellipse cx="218.315" cy="171.312" fill="#2e363a" rx="1.62" ry="2.28"
    ...
    v-1.9020081C238.032196,138.0520325,241.792099,137.5655212,243.8378754,135.1105804z" opacity=".5" />
                              ...
                              <g>
                                <ellipse cx="240.289" cy="128.515" fill="#4f2d2b" rx=".738" ry=".986" />
                              </g>
                              <g>
                                <ellipse cx="234.667" cy="128.116" fill="#4f2d2b" rx=".738" ry=".986" />
                              </g>
                              <g>
    ...
    v13.008316C218.1694336,72.4695053,216.932373,73.7065582,215.4063873,73.7065582z" />
                            <circle cx="208.225" cy="62.394" r="2.007" fill="#fff" />
    ...
    v15.7535095C92.9447937,202.3258057,91.7077408,203.5628662,90.1817551,203.5628662z" />
                          ...
                          <g>
                            <circle cx="32.412" cy="96.099" r="10.412" fill="#f0a667" />
                          </g>
                          <g>
                ...
                <div class="row align-items-center justify-content-center">
                  <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                    <div class="working-svg-container svg-container-3">
                      <svg xmlns="http://www.w3.org/2000/svg" id="Layer_01" x="0" y="0"
                        enable-background="new 0 0 750 700" version="1.1" viewBox="0 0 750 700" xml:space="preserve">
                        <g id="_x37_">
                          <path fill="#98b1e6"
                          ...
                          <linearGradient id="SVGID_1_" x1="245.081" x2="213.506" y1="400.958" y2="381.341"
                          ...
                          <g>
                            <linearGradient id="SVGID_2_" x1="2017.875" x2="2044.727" y1="593.607" y2="593.607"
                              gradientTransform="translate(-1743.927)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#ececec" />
                              <stop offset=".987" stop-color="#e0e0e0" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_3_" x1="4002.833" x2="4029.684" y1="-312.875" y2="-312.875"
                              gradientTransform="rotate(16.193 -1044.567 -13294.51)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#ececec" />
                              <stop offset=".987" stop-color="#e0e0e0" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_4_" x1="1335.072" x2="1336.648" y1="454.477" y2="454.477"
                              gradientTransform="translate(-1249.072)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#8283d0" />
                              <stop offset=".993" stop-color="#6969ad" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_5_" x1="-3099.235" x2="-3068.084" y1="509.095" y2="502.591"
                              gradientTransform="matrix(-1 0 0 1 -2803.688 0)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#30355c" />
                              <stop offset=".997" stop-color="#262c51" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_6_" x1="-3056.244" x2="-3005.239" y1="500.47" y2="500.128"
                              gradientTransform="matrix(-1 0 0 1 -2803.688 0)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#30355c" />
                              <stop offset=".997" stop-color="#262c51" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_7_" x1="-2924.176" x2="-2924.176" y1="391.204" y2="376.019"
                              gradientTransform="matrix(-1 0 0 1 -2803.688 0)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#ffd4cf" />
                              <stop offset="1" stop-color="#f8b7b3" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_8_" x1="-3064.085" x2="-3096.98" y1="419.268" y2="419.268"
                              gradientTransform="matrix(-1 0 0 1 -2803.688 0)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#30355c" />
                              <stop offset=".997" stop-color="#1d2344" />
                            </linearGradient>
                            ...
                            <linearGradient id="SVGID_9_" x1="-3093.818" x2="-3160.755" y1="429.002" y2="386.163"
                              gradientTransform="matrix(-1 0 0 1 -2803.688 0)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#30355c" />
                              <stop offset=".997" stop-color="#262c51" />
                            </linearGradient>
                          ...
                          <ellipse cx="358.064" cy="389.079" fill="#30355c" rx="9.829" ry="7.627"
                          ...
                          <g>
                            ...
                            <linearGradient id="SVGID_10_" x1="-346.86" x2="-346.86" y1="308.298" y2="296.298"
                              gradientTransform="matrix(-1 0 0 1 -178.458 0)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#ffd4cf" />
                              <stop offset="1" stop-color="#f8b7b3" />
                            </linearGradient>
                          ...
                          <g>
                            ...
                            <polygon fill="#aecbfa" points="547.275 183.672 523 183.672 522.284 189.771 546.56 189.771" />
                            <polygon fill="#aecbfa"
                            ...
                            <g>
                              <ellipse cx="674.947" cy="104.244" fill="#ea4234" rx="4.926" ry="4.381"
                                transform="rotate(-43.321 674.947 104.244)" />
                              <ellipse cx="660.493" cy="104.244" fill="#fbbc04" rx="4.926" ry="4.381"
                                transform="rotate(-43.321 660.493 104.244)" />
                              <ellipse cx="646.039" cy="104.244" fill="#58a65f" rx="4.926" ry="4.381"
                          ...
                          <g>
                            <circle cx="91.961" cy="197.786" r="41.709" fill="#aecbfa" />
                            <polygon fill="#aecbfa" points="124.779 217.473 137.218 238.272 112.341 229.517" />
                            <path fill="#fff"
                          ...
                          <g>
                            ...
                            <linearGradient id="SVGID_11_" x1="182.17" x2="162.864" y1="535.118" y2="555.145"
                              gradientTransform="translate(471.05)" gradientUnits="userSpaceOnUse">
                            ...
                            <linearGradient id="SVGID_12_" x1="120.731" x2="135.887" y1="538.899" y2="559.829"
                              gradientTransform="translate(471.05)" gradientUnits="userSpaceOnUse">
                              <stop offset="0" stop-color="#fbbc04" />
                              <stop offset="1" stop-color="#f29c03" />
                            </linearGradient>
                          ...
                          <g>
                            ...
                            <ellipse cx="509.216" cy="328.684" fill="#fff" rx="20.935" ry="18.794"
                              transform="rotate(-43.456 509.216 328.684)" />
                            <ellipse cx="510.298" cy="322.275" fill="#fbbc04" rx="6.429" ry="5.772"
                  ...
                  <div class="col-xl-8 col-lg-6 col-md-6 col-sm-12">
                    <div class="working-content content-3">
                      ...
                      <p class="title-desc text-muted">Sea takimata sea sit justo
                        consetetur et diam erat erat, dolor vero et sit duo dolor,
                        dolores ipsum gubergren stet.</p>
                      <p class="title-desc text-muted mb-0">Stet sadipscing lorem ipsum
                ...
                <div class="row align-items-center justify-content-center">
                  <div class="col-xl-8 col-lg-6 col-md-6 col-sm-12 myorder-2">
                    <div class="working-content content-4">
                      <h4 class="mb-3">Life Time Updates</h4>
                      <p class="title-desc text-muted">Sea takimata sea sit justo
                        consetetur et diam erat erat, dolor vero et sit duo dolor,
                        dolores ipsum gubergren stet.</p>
                      <p class="title-desc text-muted mb-0">Stet sadipscing lorem ipsum
                  ...
                  <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 myorder-1">
                    <div class="working-svg-container svg-container-4">
                      <svg xmlns="http://www.w3.org/2000/svg" width="2000" height="2000"
                        enable-background="new 0 0 2000 2000" viewBox="0 0 2000 2000">
    ...
    c43.1,0,78.1,35,78.1,78.1V1727C1293.4,1770.2,1258.5,1805.1,1215.3,1805.1z" />
                        <rect width="588.9" height="907.3" x="668.5" y="741.6" fill="#E1F5FE" />
    ...
    c17.4,0,31.5,14.1,31.5,31.5v0C1065.1,1729.4,1051,1743.6,1033.6,1743.6z" />
                        <ellipse cx="1329.5" cy="482.5" fill="#33B2F2" rx="29" ry="17.4" />
    ...
    l41.6,157.5c6,22.7-7.5,45.9-30.2,51.9h0C1344.1,609.4,1320.9,595.9,1314.9,573.2z" />
                          <rect width="88.1" height="51.3" x="1338.7" y="951.1" fill="#FFAB91" />
                          <path fill="#4F4F4F" d="M1448.9,1013.6h-119.3v-19.2c0-6.2,5-11.2,11.2-11.2h108V1013.6z" />
    ...
    H1335.2z" />
                          <path fill="#333" d="M1140.7,185.5L1140.7,185.5c20.4,0,36.9-16.5,36.9-36.9V97.9h-36.9V185.5z" />
    ...
    V546.1z" />
                          <rect width="64.7" height="70.4" x="1076" y="211.1" fill="#FFAB91" />
    ...
    C1219.4,613.7,1169.7,663.4,1108.4,663.4z" />
                          <rect width="88.1" height="51.3" x="1229.6" y="951.1" fill="#FFAB91" />
                          <path fill="#4F4F4F" d="M1339.8,1013.6h-119.3v-19.2c0-6.2,5-11.2,11.2-11.2h108V1013.6z" />
    ...
    H1226.1z" />
                          <rect width="262.3" height="16.8" x="1040.6" y="562.9" fill="#058ACC" />
                          <path fill="#2AB1F4"
    ...
    C1416.5,574.1,1409.6,579.7,1401.6,579.7z" />
                          <polygon fill="#2AB1F4" points="1203 393.1 1212.2 387.6 1208.3 405.5 1200.3 405.5" />
    ...
    C431.3,1830.2,378.4,1777.3,378.4,1712z" />
      ...
      <section class="section landing-Features">
        <div class="container text-center">
          <h2 class="text-center fw-medium text-fixed-white">Features</h2>
          <h4 class="fw-medium mb-2 text-fixed-white ">Features Used in Spruha Admin Template</h4>
            ...
            <div class="justify-content-center">
              ...
              <swiper 
                    :breakpoints="{
                     ...
                     :loop="true" :autoplay="true" :modules="modules">
                    <swiper-slide><img src="/images/media/landing/web/1.png" alt="image"><h5 class="text-center mt-2 text-fixed-white">Bootstrap5</h5></swiper-slide>
                    <swiper-slide><img src="/images/media/landing/web/nuxt.png" alt="image"><h5 class="text-center mt-2 text-fixed-white">NUXT</h5></swiper-slide>
                    <swiper-slide><img src="/images/media/landing/web/vue.png" alt="image"><h5 class="text-center mt-2 text-fixed-white">VUE</h5></swiper-slide>
                    <swiper-slide><img src="/images/media/landing/web/4.png" alt="image"><h5 class="text-center mt-2 text-fixed-white">Sass</h5></swiper-slide>
                    <swiper-slide><img src="/images/media/landing/web/pinia.svg" alt="image"><h5 class="text-center mt-2 text-fixed-white">Pinia</h5></swiper-slide>
                    <swiper-slide><img src="/images/media/landing/web/6.png" alt="image"><h5 class="text-center mt-2 text-fixed-white">NPM</h5></swiper-slide>
                </swiper>
              </div>
            </div>
          </div>
      ...
      <section class="section highlights" id="highlights">
        <div class="container text-center">
          <div class="row">
            <h4 class="text-center fw-medium">Highlights</h4>
            <span class="landing-title"></span>
            <h2 class="text-center fw-medium">Switch Easily From Vertical to Horizontal Menu</h2>
          </div>
          <div class="row justify-content-center">
            <div class="col-xl-7">
              <p class=" fs-15 mb-5 fw-normal">The Spruha – Vue3 Dashboard Template
                is available in both vertical and
                horizontal menus.
                    ...
                    <div class="accordion-item acc-primary">
                      ...
                      <div id="collapsecustomicon1One" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                          <p>
                            The Spruha – Vue3 Dashboard Template
                             is available in both vertical and
                            horizontal menus.
                            Both menus are managed by single assets. Where
                            users can easily switch from vertical to
                          ...
                          <a href="javascript:void(0);" class="btn btn-outline-primary fs-13">Click
                            here</a>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item acc-secondary">
                      ...
                      <div id="collapsecustomicon1Two" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                          <p class="mb-3">
                            The Spruha – Vue3 Dashboard Template
                             is available in LRT & RTL versions with
                            single assets.
                          ...
                          <a href="javascript:void(0);" class="btn btn-outline-pink tx-13">Click
                            here</a>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item acc-success">
                      ...
                      <div id="collapsecustomicon1Three" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                          <p class="mb-3">
                            The Spruha – Vue3 Dashboard Template
                             is available in different types of
                            color styles.
                  ...
                  <div class="accordion accordion-customicon1 accordion-primary accordions-items-seperate"
                    ...
                    <div class="accordion-item acc-info">
                      ...
                      <div id="collapsecustomicon2Five" class="accordion-collapse collapse"
                        aria-labelledby="headingcustomicon2Five" data-bs-parent="#accordionFAQ20">
                        <div class="accordion-body">
                          <p>
                            The Spruha – Vue3 Dashboard Template
                             is also available in two different
                            types of layouts
                          ...
                          <a href="javascript:void(0);" class="btn btn-outline-info tx-13">Click
                            here</a>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item acc-danger">
                      ...
                      <div id="collapsecustomicon2Six" class="accordion-collapse collapse"
                        aria-labelledby="headingcustomicon2Six" data-bs-parent="#accordionFAQ20">
                        <div class="accordion-body">
                          <p>
                            The Spruha – Vue3 Dashboard Template
                             is also available in different types of
                            Side Menu Styles.
                          ...
                          <a href="javascript:void(0);" class="btn btn-outline-danger tx-13">Click
                            here</a>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item acc-warning">
                      <h2 class="accordion-header" id="headingcustomicon2Four">
                        <button class="accordion-button text-warning" type="button" data-bs-toggle="collapse"
                      ...
                      <div id="collapsecustomicon2Four" class="accordion-collapse collapse show"
                        aria-labelledby="headingcustomicon2Four" data-bs-parent="#accordionFAQ20">
                        <div class="accordion-body">
                          <p>
                            The Spruha – Vue3 Dashboard Template
                             is also available in two
      ...
      <section class="section section-bg" id="pricing">
        <div class="container text-center">
          <div class="row">
            <h4 class="text-center fw-medium landing-card-header">Choose a plan </h4>
            <span class="landing-title"></span>
            <h2 class="text-center fw-medium">Find the <span class="text-primary">Perfect
                Plan</span> for your Business.</h2>
            <div class="pricing-tabs text-center">
              <div class="pri-tabs-heading text-center mt-3">
                <ul class="nav nav-price">
                  <li><a data-bs-toggle="tab" href="#month" class="monthly">Monthly</a></li>
                  <li><a class="active show annualy" data-bs-toggle="tab" href="#annualyear">Annual</a></li>
                </ul>
              </div>
              <div class="tab-content text-start">
                <div class="tab-pane pb-0 active show" id="annualyear">
                  <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                      <div class="card pricing-card reveal revealrotate">
                        <div class="card-header d-block text-justified py-3">
                          <p class="fs-18 fw-medium mb-1">Basic</p>
                          <p class="text-justify fw-medium mb-1"> <span class="fs-30 me-2">$</span><span
                              class="fs-30 me-1">399</span><span class="fs-25"><span
                        ...
                        <div class="card-body py-2">
                          <ul class="text-justify pricing-body ps-0 mb-0">
                            <li><i class="mdi mdi-checkbox-marked-circle-outline p-2 fs-16 text-secondary"></i><strong>
                                2 Free</strong> Domain Name</li>
                            <li><i class="mdi mdi-checkbox-marked-circle-outline p-2 fs-16 text-secondary"></i>
                        ...
                        <div class="card-footer text-center border-top-0 py-3 d-grid">
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                      <div class="card border bg-primary border-primary pricing-card advanced reveal revealrotate">
                        <div class="p-3 d-block text-justified bd-b-white-2">
                          <p class="fs-18 fw-medium mb-1 pe-0">Advanced<span
                              class="badge bg-white text-primary float-end fw-normal">Limited
                              Deal</span></p>
                          <p class="text-justify fw-medium mb-1"> <span class="fs-30 me-2">$</span><span
                              class="fs-30 me-1">1,299</span><span class="fs-25"><span
                                class="op-0-5 text-muted text-20">/</span>
                              year</span></p>
                          <p class="fs-13 mb-2">Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Iure quos debitis
                            aliquam .</p>
                          <p class="fs-13 mb-1">Billed monthly on
                            regular basis!</p>
                        </div>
                        <div class="card-body py-2">
                          <ul class="text-justify pricing-body ps-0 my-5">
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-fixed-white p-2 fs-16"></i>
                              <strong> 5 Free</strong> Domain Name
                            </li>
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-fixed-white p-2 fs-16"></i><strong>5
                              </strong> One-Click Apps</li>
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-fixed-white p-2 fs-16"></i><strong>
                            ...
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-fixed-white p-2 fs-16"></i><strong>
                                Money </strong> BackGuarantee</li>
                            <li class=""><i
                                class="mdi mdi-checkbox-marked-circle-outline text-fixed-white p-2 fs-16"></i><strong>
                                24/7</strong> support</li>
                          </ul>
                        </div>
                        <div class="text-center border-top-0 p-3 d-grid">
                          <button class="btn btn-lg btn-white text-primary">
                            <span class="ms-4 me-4">Select</span>
                          </button>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                      <div class="card pricing-card reveal revealrotate">
                        <div class="card-header d-block text-justified py-3">
                          <p class="fs-18 fw-medium mb-1">Regular</p>
                          <p class="text-justify fw-medium mb-1"> <span class="fs-30 me-2">$</span><span
                              class="fs-30 me-1">899</span><span class="fs-25"><span
                                class="op-0-5 text-muted text-20">/</span>
                              year</span></p>
                          <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Iure quos debitis
                        ...
                        <div class="card-body py-2">
                          <ul class="text-justify pricing-body ps-0 mb-0">
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-danger p-2 fs-16"></i><strong>
                                1 Free</strong> Domain Name</li>
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-danger p-2 fs-16"></i><strong>4
                              </strong> One-Click Apps</li>
                            <li><i class="mdi mdi-checkbox-marked-circle-outline text-danger p-2 fs-16"></i><strong>
                ...
                <div class="tab-pane" id="month">
                  <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                      <div class="card pricing-card">
                        <div class="card-header d-block text-justified py-3">
                          <p class="fs-18 fw-medium mb-1">Basic</p>
                          <p class="text-justify fw-medium mb-1"> <span class="fs-30 me-2">$</span><span
                              class="fs-30 me-1">39</span><span class="fs-25"><span
                                class="op-0-5 text-muted text-20">/</span>
                              month</span></p>
                          <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Iure quos debitis
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                      <div class="card border-primary pricing-card advanced">
                        <div class="card-header d-block text-justified py-3">
                          <p class="fs-18 fw-medium mb-1 pe-0">Advanced<span
                              class="tag bg-primary text-fixed-white float-end rounded-2">Limited
                              Deal</span></p>
                          <p class="text-justify fw-medium mb-1"> <span class="fs-30 me-2">$</span><span
                              class="fs-30 me-1">199</span><span class="fs-25"><span
                                class="op-0-5 text-muted text-20">/</span>
                              month</span></p>
                          <p class="fs-13 mb-2">Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Iure quos debitis
                        ...
                        <div class="card-footer text-center border-top-0 py-3 d-grid">
                          <button class="btn btn-lg btn-primary-gradient text-fixed-white">
                            <span class="ms-4 me-4">Select</span>
                          </button>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                      <div class="card pricing-card">
                        <div class="card-header d-block text-justified py-3">
                          <p class="fs-18 fw-medium mb-1">Regular</p>
                          <p class="text-justify fw-medium mb-1"> <span class="fs-30 me-2">$</span><span
                              class="fs-30 me-1">69</span><span class="fs-25"><span
                                class="op-0-5 text-muted text-20">/</span>
                              month</span></p>
                          <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Iure quos debitis
      ...
      <!-- Start:: Section-7 -->
      <section class="section highlights" id="faq">
        <div class="container">
          <div class="row">
            <h4 class="text-center fw-medium landing-card-header">FAQ'S ?</h4>
            <span class="landing-title"></span>
            <h2 class="text-center fw-medium">We are here to help you</h2>
            <div class="row justify-content-center">
              <p class="col-xl-9 wow fadeInUp text-default sub-text mb-5" data-wow-delay="0s">
                The Spruha Vue admin template is one of the modern dashboard templates.
            ...
            <div class="row align-items-center">
              <div class="col-md-12 col-lg-6 px-4">
                <div class="accordion accordion-customicon1 accordion-primary accordions-items-seperate"
                  id="accordionFAQ2">
                  <div class="accordion-item acc-primary">
                    <h2 class="accordion-header" id="headingcustomicon20Five">
                      <button class="accordion-button collapsed text-primary" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon20Five" aria-expanded="false"
                        aria-controls="collapsecustomicon20Five">
                        <span class="me-3 fs-18 fw-bold">01.</span>Can i get a free trial before purchase ?
                      </button>
                    </h2>
                    <div id="collapsecustomicon20Five" class="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon20Five" data-bs-parent="#accordionFAQ2">
                      <div class="accordion-body">
                        <p>
                        ...
                        <a href="javascript:void(0);" class="btn btn-outline-primary tx-13">Click here</a>
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item acc-danger">
                    <h2 class="accordion-header" id="headingcustomicon21Six">
                      <button class="accordion-button collapsed text-danger" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon21Six" aria-expanded="false"
                        aria-controls="collapsecustomicon21Six">
                        <span class="me-3 fs-18 fw-bold">02.</span>What type of files i will get after purchase ?
                      </button>
                    </h2>
                    <div id="collapsecustomicon21Six" class="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon21Six" data-bs-parent="#accordionFAQ2">
                      <div class="accordion-body">
                        <p>
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Iure quos debitis aliquam.
                  ...
                  <div class="accordion-item acc-success">
                    <h2 class="accordion-header" id="headingcustomicon22Six">
                      <button class="accordion-button collapsed text-success" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon22Six" aria-expanded="false"
                        aria-controls="collapsecustomicon22Six">
                        <span class="me-3 fs-18 fw-bold">03.</span>What is a single Application
                      </button>
                    </h2>
                    <div id="collapsecustomicon22Six" class="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon22Six" data-bs-parent="#accordionFAQ2">
                      <div class="accordion-body">
                        <p>
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Iure quos debitis aliquam.
                  ...
                  <div class="accordion-item acc-secondary">
                    <h2 class="accordion-header" id="headingcustomicon23Six">
                      <button class="accordion-button collapsed text-secondary" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon23Six" aria-expanded="false"
                        aria-controls="collapsecustomicon23Six">
                        <span class="me-3 fs-18 fw-bold">04.</span>How to get future updates ?
                      </button>
                    </h2>
                    <div id="collapsecustomicon23Six" class="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon23Six" data-bs-parent="#accordionFAQ2">
                      <div class="accordion-body">
                        <p>
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Iure quos debitis aliquam.
                        ...
                        <a href="javascript:void(0);" class="btn btn-outline-pink tx-13">Click here</a>
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item acc-info">
                    <h2 class="accordion-header" id="headingcustomicon24Six">
                      <button class="accordion-button collapsed text-info" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon24Six" aria-expanded="false"
                        aria-controls="collapsecustomicon24Six">
                        <span class="me-3 fs-18 fw-bold">05.</span>Do you provide support ?
                      </button>
                    </h2>
                    <div id="collapsecustomicon24Six" class="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon24Six" data-bs-parent="#accordionFAQ2">
                      <div class="accordion-body">
                        <p>
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Iure quos debitis aliquam.
                        ...
                        <a href="javascript:void(0);" class="btn btn-outline-info tx-13">Click here</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <!-- Start:: Section-8 -->
      <section class="section landing-testimonials section-bg px-3" id="Clients">
        <div class="container text-center">
          <div class="row">
            <h4 class="text-center fw-medium landing-card-header">Testimonials </h4>
            <span class="landing-title"></span>
            <h2 class="text-center fw-medium mb-5">What People Are
              Saying About Our Product.</h2>

            <swiper :navigation="true" :pagination="pagination" :loop="true" :autoplay="true" :modules="modules" class=" pagination-dynamic text-start"
              :breakpoints="{
                '0': {
                  slidesPerView: 1,
                  spaceBetween: 20,
      ...
      <section class="section" id="contact">
        <div class="container">
          <div class="row">
            <h4 class="text-center fw-semibold mt-7 landing-card-header ">Contact</h4>
            <span class="landing-title"></span>
                                ...
                                <div class="card-body p-0">
                                  <div class="counter-status">
                                    ...
                                    <h4 class="mb-2 fw-semibold">
                                      Main Branch</h4>
                                    <p class="title-desc mb-1">150 Burno
                                      Street</p>
                    ...
                    <div class="">
                      <form class="reveal">
                        ...
                        <div class="form-group">
                          ...
                          <textarea rows="5" class="form-control" id="cusMessage"
    ...
    <!-- Start:: Section-11 -->
    <section class="section landing-footer pb-0 text-fixed-white demo-footer px-4">
      <div class="container">
        <div class="row">
          <div class="p-2 mb-0">
            <div class="card-body p-0">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2 col-sm-6 col-md-4 reveal revealleft position-relative">
                    ...
                    <ul class="mb-5 mb-lg-0 ps-0">
                      <li><router-link :to="`${url}dashboard`">Dashboard</router-link></li>
                      <li><router-link :to="`${url}elements/alerts`">Elements</router-link></li>
                      <li><router-link :to="`${url}forms/form-elements/inputs`">Forms</router-link></li>
                      <li><router-link :to="`${url}charts/apexchart/line`">Charts</router-link></li>
                      <li><router-link :to="`${url}apps/tables/basic`">Tables</router-link></li>
                      <li><router-link :to="`${url}utilities/more`">Other Pages</router-link></li>
                    </ul>
                  </div>
                  <div class="col-lg-2 col-sm-6 col-md-4 reveal revealleft position-relative ">
                    <h6>Information</h6>
                    <ul class="mb-5 mb-lg-0 ps-0">
                      <li><router-link :to="`${url}elements/listgroup`">Our Team</router-link></li>
                      <li><router-link :to="`${url}advancedui/contacts`">Contact US</router-link></li>
                      <li><router-link :to="`${url}pages/aboutus`">About</router-link></li>
                      <li><router-link :to="`${url}advancedui/search`">Services</router-link></li>
                      <li><router-link :to="`${url}apps/blog/blog-page`">Blog</router-link></li>
                      <li><router-link :to="`${url}pages/settings`">Terms and Services</router-link></li>
                    </ul>
                  </div>
                  <div class="col-lg-4 col-sm-12 col-md-4 reveal revealleft">
                    <div class="">
                      <router-link :to="`${url}dashboard`">
                        <img loading="lazy" alt="" class="logo mb-3" src="/images/brand-logos/desktop-white.png" />
                      </router-link>
                    ...
                    <div class="btn-list mt-6">
                      ...
                      <button type="button" class="btn btn-icon rounded-pill"><i class="fs-14 fe fe-github"></i></button>
                      <button type="button" class="btn btn-icon rounded-pill"><i class="fs-14 fe fe-twitter"></i></button>
                      <button type="button" class="btn btn-icon rounded-pill"><i
              ...
              <footer class="main-footer px-0 text-center">
                <div class="row ">
                  <div class="col-md-12 col-sm-12">
                    Copyright © <span id="year">2024</span> <a href="javascript:void(0)">Spruha</a>.
