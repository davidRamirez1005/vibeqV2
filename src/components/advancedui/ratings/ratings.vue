<template>
  <Pageheader heading="Rating" :maintitle='["Adavanced-UI","Ratings"]' />
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            <p class="fs-14 mb-0 fw-semibold">Show Some <span class="text-danger">&#10084;</span> with rating :
            </p>
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <star-rating :star-size="20" :increment="0.5" :show-rating="false"></star-rating>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex flex-wrap align-items-center">
              <star-rating :star-size="20" text-class="live-rating badge bg-success-transparent ms-3"></star-rating>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <star-rating :max-rating="10" :star-size="20" :show-rating="false"></star-rating>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div style="display:inline-block;">
              Rated
              <star-rating :inline="true" :star-size="20" :show-rating="false" :rating="5"></star-rating>
              by our customers.
      ...
      <div class="card custom-card">
        ...
        <div class="card-body">
          <div class="d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex flex-wrap align-items-center">
              <star-rating :star-size="20" v-model:rating="resetableRating" :show-rating="false"></star-rating>
              <button class="btn btn-icon btn-sm btn-danger-light ms-3" id="rater-reset-button"
                @click="resetableRating = 0;">
