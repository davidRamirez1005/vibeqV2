...
<template>
    <Pageheader heading="Draggable cards" :maintitle='["Advanced-UI", "Draggable cards"]' />

    <!-- Start::row-1 -->
    <div class="row">
        <draggable group="people" itemKey="name" class="col-xl-6" id="draggable-left">
        ...
        <draggable group="people" itemKey="name" class="col-xl-6" id="draggable-right">
            ...
            <div class="card custom-card">
                <div class="card-header border-bottom-0 justify-content-between pb-3">
                    <div class="card-title">
