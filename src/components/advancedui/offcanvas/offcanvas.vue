<template>
  <Pageheader heading="Offcanvas" :maintitle='["Advanced-UI", "Offcanvas"]' />

  <!-- Start:: row-1 -->
  <div class="row">
    <div class="col-xl-4">

      <showcodeCard :code="prism.LiveDemo" title="Live demo">
        <a class="btn btn-primary mb-1 me-2" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
              ...
              <ul class="list-group list-group-flush mb-0">
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      <p class="fw-semibold mb-0">New Website Created<span class="badge bg-light text-muted float-end">20
                          Nov 2022</span></p>
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>30 mins
                        ago</span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>2 hrs
                        ago</span>
                    </div>
                  </div>
                </li>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      <p class="fw-semibold mb-0">Decide the live discussion<span
                          class="badge bg-light text-muted float-end ms-1">17 Feb 2023</span></p>
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>3 hrs
                        ago</span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      <p class="fw-semibold mb-0">Meeting at 3:00 pm<span class="badge bg-light text-muted float-end">29
                          Dec 2022</span></p>
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>4 hrs
                        ago</span>
                    </div>
                  </div>
                </li>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>7 hrs
                        ago</span>
                    </div>
                  </div>
                </li>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>45 mins
                        ago</span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>28 mins
                        ago</span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>14 hrs
                        ago</span>
                    </div>
                  </div>
                </li>
    ...
    <div class="col-xl-4">
      ...
      <showcodeCard :code="prism.BodyScrolling" title="Body scrolling">
  ...
  <div class="row">
    <div class="col-xl-3">
      ...
      <showcodeCard :code="prism.BodyScrollingAndBackdrop" title="Body scrolling and backdrop">
              ...
              <ul class="list-group list-group-flush mb-0">
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>30
                        mins
                        ago</span>
                    </div>
                  </div>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      <p class="fw-semibold mb-0">Decide the live discussion<span
                          class="badge bg-light text-muted float-end ms-1">17 Feb 2023</span>
                      </p>
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>3 hrs
                        ago</span>
                    </div>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>45
                        mins
                        ago</span>
                    </div>
                  </div>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-fill">
                      ...
                      <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>28
                        mins
                        ago</span>
                    </div>
                  </div>
    ...
    <div class="col-xl-5">
      <showcodeCard :code="prism.Placement" title="Placement">
        <button class="btn btn-primary mb-1  me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
        ...
        <button class="btn btn-primary mb-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
...
import * as prism from '@/data/prismCode/ui-elements/offcanvas.js';
