<template>
  <Pageheader heading="Cards" :maintitle='["Advanced-UI", "Cards"]' />
  <!-- Start::row-1 -->
  <div class="row row-sm">
    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
      <div class="card custom-card">
        <img src="/images/media/media-22.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h6 class="card-title fw-semibold">Card title</h6>
          <p class="card-text text-muted">when an unknown printer took a galley of type and scrambled it to make a type
    ...
    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
      <div class="card custom-card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one
            of the more obscure Latin words, consectetur, from a Lorem Ipsum passage</p>
          <a href="javascript:void(0);" class="btn btn-primary">Read More</a>
        </div>
      </div>
      <div class="card custom-card">
        <div class="card-body">
          ...
          <p class="card-text">There are many variations of passages of Lorem Ipsum available, but the majority have
            suffered alteration many variations of passages of Lorem Ipsum available there are so many ways to solve but
    ...
    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
      <div class="card custom-card">
        <img src="/images/media/media-23.jpg" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
      <div class="card custom-card">
        <img src="/images/media/media-24.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h6 class="card-title fw-semibold">Card title</h6>
          <p class="card-text">Some quick example text to build on the card title and
            make up the bulk of the card's content.</p>
          ...
          <div class="card custom-card">
            <div class="card-body">
              <blockquote class="blockquote mb-0 text-center">
                ...
                <footer class="blockquote-footer mt-2 fs-14">Someone famous in <cite title="Source Title">Source
                    Title</cite></footer>
              </blockquote>
            </div>
          </div>
    ...
    <div class="col-xxl-6 col-xl-6 col-lg-12">
      ...
      <div class="row row-cols-12">
        <div class="col">
          <div class="card custom-card">
            <div class="card-body">
              <img src="/images/media/media-25.jpg" class="card-img mb-3" alt="...">
        ...
        <div class="col">
          <div class="card custom-card">
            <div class="card-body">
              <img src="/images/media/media-26.jpg" class="card-img mb-3" alt="...">
        ...
        <div class="col">
          <div class="card custom-card">
            <div class="card-body">
              <img src="/images/media/media-27.jpg" class="card-img mb-3" alt="...">
        ...
        <div class="col-xl-4">
          <div class="card text-center custom-card">
            <div class="card-body">
              ...
              <p class="card-text">Many desktop publishing packages and web page editors now use Lorem Ipsum as their
  ...
  <div class="row row-sm">
    <div class="col-xl-3">
      <div class="card custom-card">
        ...
        <div class="card-body">
          If you are going to use, you need to be sure there isn't anything embarrassing hidden in the middle of text. All
    ...
    <div class="col-xl-3">
      <div class="card custom-card text-center">
        ...
        <div class="card-body pt-1">
          ...
          <div class="btn-list">
            <button class="btn btn-facebook btn-wave">
              <i class="ri-facebook-line align-middle"></i>
            </button>
            <button class="btn btn-twitter btn-wave">
              <i class="ri-twitter-line align-middle"></i>
            </button>
            <button class="btn btn-instagram btn-wave">
      ...
      <div class="card custom-card border border-primary">
        <div class="card-body">
          <svg class="footer-card-icon my-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <path d="M19 20.75H3a2 2 0 0 1-2-2V19a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-.25a2 2 0 0 1-2 2z" opacity=".1" />
            ...
            <path fill="#FFF" d="M6 4h1v5H6zM13 14h6v1h-6zM13 17h6v1h-6zM4.379 15.086l.707-.707 3.535 3.535-.707.707z" />
    ...
    <div class="col-xl-2">
      <div class="card custom-card">
        <div class="card-body">
          <img src="/images/media/media-4.jpg" class="card-img mb-3" alt="...">
    ...
    <div class="col-xl-2">
      <div class="card custom-card">
        <div class="card-body">
          <img src="/images/media/media-9.jpg" class="card-img mb-3" alt="...">
    ...
    <div class="col-xl-2">
      <div class="card custom-card">
        <div class="card-body">
          <img src="/images/media/media-15.jpg" class="card-img mb-3" alt="...">
    ...
    <div class="col-xl-3">
      <div class="card custom-card text-center">
        ...
        <div class="card-body">
          ...
          <a href="javascript:void(0);" class="btn btn-outline-secondary mt-2 ms-1">Close</a>
        </div>
    ...
    <div class="col-xl-3">
      <div class="card custom-card">
        ...
        <div class="card-body">
          ...
          <p class="mb-0 card-text">Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original
            form, accompanied by English versions </p>
        </div>
      </div>
    </div>
    <div class="col-xl-4">
      <div class="card custom-card">
        <div class="card-header justify-content-between pb-3">
          ...
          <a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false"
        ...
        <div class="collapse show" id="collapseExample">
          <div class="card-body pt-2">
            ...
            <p class="card-text mb-0">There are many variations of passages of Lorem Ipsum available, but the majority
    ...
    <div class="col-xl-4">
      <fullscreen_closableCard :showCardVal="true" title="Card With Close Button" :hasClose=true>
      ...
      </fullscreen_closableCard>
    </div>
    <div class="col-xl-4">
      <fullscreen_closableCard :showCardVal="true" title="Card With Fullscreen Button" :hasFullScreen=true>
  ...
  <div class="row row-sm">
    <div class="col-xl-4">
      <div class="card custom-card">
        <img src="/images/media/media-29.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h6 class="card-title fw-semibold">Image caps are widely used in Blog's</h6>
          <p class="card-text mb-3 text-muted">But I must explain to you how all this mistaken idea of denouncing pleasure
    ...
    <div class="col-xl-4">
      <div class="card custom-card">
        ...
        <img src="/images/media/media-28.jpg" class="card-img-bottom" alt="...">
      </div>
    </div>
    <div class="col-xl-4">
      <div class="card custom-card">
        ...
        <img src="/images/media/media-30.jpg" class="card-img rounded-0" alt="...">
        <div class="card-body">
          <p class="card-text mb-0"><small>Last updated 3 mins
              ago</small></p>
        </div>
    ...
    <div class="col-xl-4">
      <div class="card custom-card">
        ...
        <img src="/images/media/media-31.jpg" class="card-img rounded-0" alt="...">
        <div class="card-footer">
          <p class="card-text mb-0"><small>Last updated 3 mins
              ago</small></p>
        </div>
    ...
    <div class="col-xl-4">
      <div class="card custom-card">
        <img src="/images/media/media-32.jpg" class="card-img-top" alt="...">
        <div class="card-header">
          <div class="card-title">Image caps are widely used in Blog's</div>
        </div>
        <div class="card-body">
    ...
    <div class="col-xl-4">
      <div class="card custom-card">
        ...
        <img src="/images/media/media-33.jpg" class="card-img-bottom" alt="...">
      </div>
    </div>
  </div>
  <!-- End::row-6 -->
  ...
  <div class="row row-sm">
    <div class="col-xl-4">
      <div class="card custom-card overlay-card">
        <img src="/images/media/media-35.jpg" class="card-img" alt="...">
        <div class="card-img-overlay d-flex flex-column p-0">
          ...
          <div class="card-body text-fixed-white">
            <div class="card-text mb-2 text-truncate">There are many variations of passages of Lorem Ipsum available, but
    ...
    <div class="col-xl-4">
      <div class="card custom-card overlay-card">
        <img src="/images/media/media-36.jpg" class="card-img" alt="...">
    ...
    <div class="col-xl-4">
      <div class="card custom-card overlay-card">
        <img src="/images/media/media-34.jpg" class="card-img" alt="...">
        <div class="card-img-overlay d-flex flex-column p-0">
          <div class="card-header border-bottom-0">
            <div class="card-title text-fixed-white">
              Image Overlays Are Awesome!
          ...
          <div class="card-body text-fixed-white">
            <div class="card-text text-truncate">There are many variations of passages of Lorem Ipsum available, but the
  ...
  <div class="row row-sm">
    <div class="col-xl-4">
      <div class="card custom-card">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="/images/media/media-37.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-header">
      ...
      <div class="card custom-card">
        <div class="row g-0">
          <div class="col-md-8">
            ...
            <div class="card-body">
              <h6 class="card-title fw-semibold">Horizontal cards are awesome!</h6>
              <p class="card-text mb-3">This is a wider card with suppo rting text below as a natural lead-in to
                additional content. This content is a little bit longer.</p>
              <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
          </div>
          <div class="col-md-4">
            <img src="/images/media/media-38.jpg" class="img-fluid rounded-end h-100 w-100" alt="...">
          </div>
        </div>
      </div>
    </div>
    <div class="col-xl-4">
      <div class="card custom-card">
        <div class="row g-0">
          ...
          <div class="col-md-4">
            <img src="/images/media/media-39.jpg" class="img-fluid rounded-end h-100 w-100" alt="...">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row row-sm">
    <div class="col-xl-12">
      <div class="card-group">
        <div class="card custom-card">
          <img src="/images/media/media-40.jpg" class="card-img-top" alt="...">
          <div class="card-body">
        ...
        <div class="card custom-card">
          <img src="/images/media/media-41.jpg" class="card-img-top" alt="...">
          <div class="card-body">
        ...
        <div class="card custom-card">
          <img src="/images/media/media-42.jpg" class="card-img-top" alt="...">
          <div class="card-body">
  ...
  <div class="row row-sm">
      ...
      <div class="row">
        <div class="col-xxl-12 col-xl-12">
          <div class="card custom-card card-bg-primary">
            ...
            <div class="card-body">
              <blockquote class="blockquote mb-0 text-center">
                <h6>The best and most beautiful things in the world cannot be seen or even touched — they must be felt
                  with the heart..</h6>
            ...
            <div class="row g-0">
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text mb-0">This is a wild animal with supporting tactics and are very efficient at
                    kill,they are very Dangerous.</p>
              ...
              <div class="col-md-4">
                <img src="/images/media/media-39.jpg" class="img-fluid rounded-end h-100" alt="...">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="col-xxl-3 col-xl-6">
      <div class="card custom-card">
        <a href="javascript:void(0);" class="card-anchor"></a>
        <img src="/images/media/media-47.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
          <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything
  ...
  <div class="row row-sm">
    <div class="col-xl-12">
      <div class="row row-cols-1 row-cols-md-4 g-4">
        ...
        <div class="col">
          <div class="card custom-card">
            <img src="/images/media/media-45.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
              <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't
                anything embarrassing hidden in the middle of text.</p>
        ...
        <div class="col">
          <div class="card custom-card">
            <img src="/images/media/media-46.jpg" class="card-img-top" alt="...">
            <div class="card-body">
...
import fullscreen_closableCard from '@/shared/UI/fullscreen_closableCard.vue'

export default {
  components: { Pageheader, fullscreen_closableCard },
};
</script>
