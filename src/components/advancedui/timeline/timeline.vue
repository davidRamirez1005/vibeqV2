<template>
  <Pageheader heading="Timeline" :maintitle='["Advanced-UI", "Timeline"]' />
          ...
          <div class="vtimeline">
            <div class="timeline-wrapper timeline-wrapper-primary">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  ...
                  <span>19</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>19 Oct 2020</span
                  >
                </div>
              </div>
            </div>
            <div class="timeline-wrapper timeline-inverted timeline-wrapper-secondary">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  ...
                  <span>25</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>10th Oct 2020</span
                  >
                </div>
              </div>
            </div>
            <div class="timeline-wrapper timeline-wrapper-info">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p>
                    Alpha 5 has arrived just over a month after Alpha 4 with some major
                    feature improvements and a boat load of bug fixes.
                  </p>
                </div>
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  <i class="fe fe-heart text-muted me-1"></i>
                  <span>19</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>5th Oct 2020</span
                  >
                </div>
              </div>
            </div>
            <div class="timeline-wrapper timeline-inverted timeline-wrapper-danger">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p>
                    Pianoforte principles our unaffected not for astonished travelling are
                    particular.
                  </p>
                  <img src="/images/media/jobs-landing/blog/5.jpg" class="mb-3" alt="img" />
                </div>
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  <i class="fe fe-heart text-muted me-1"></i>
                  <span>19</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>27th Sep 2017</span
                  >
                </div>
              </div>
            </div>
            <div class="timeline-wrapper timeline-wrapper-success">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  ...
                  <span>25</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>25th Sep 2017</span
                  >
                </div>
              </div>
            </div>
            <div class="timeline-wrapper timeline-inverted timeline-wrapper-warning">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  ...
                  <span>32</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>19th Sep 2017</span
                  >
                </div>
              </div>
            </div>
            <div class="timeline-wrapper timeline-wrapper-dark">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-footer d-flex align-items-center flex-wrap">
                  ...
                  <span>26</span>
                  <span class="ms-auto"
                    ><i class="fe fe-calendar text-muted mx-1"></i>15th Sep 2017</span
                  >
                </div>
              </div>
            </div>
