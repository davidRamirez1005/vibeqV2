export let
    stackedAvatars = {
        script: `<div class="avatar-list-stacked">
        <span class="avatar">
    ...
    avatars = {
        script: `<span class="avatar me-2 avatar-radius-0">
    ...
    avatarSizes = {
        script: `<span class="avatar avatar-xs me-2">
        <img src="/images/faces/4.jpg" alt="img">
      </span>
    ...
    avatarWithOnlineStatus = {
        script: `<span class="avatar avatar-xs me-2 online avatar-rounded">
        <img src="/images/faces/8.jpg" alt="img">
      </span>
    ...
    avatarWithOfflineStatus = {
        script: `<span class="avatar avatar-xs me-2 offline avatar-rounded">
        <img src="/images/faces/2.jpg" alt="img">
      </span>
    ...
    avatarWithInitials = {
        script: `<span class="avatar avatar-xs m-2 bg-primary">
        xs
      </span>
